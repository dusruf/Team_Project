...
public class ContactMessage {
	...
	private int cmAnswer;

	public ContactMessage(int cmSeq, String hhId, String hhName, String personId, String personName,
			String contactTitle, String contactMessage, String cmIndate, int cmStatus, int cmAnswer) {
		super();
		this.cmSeq = cmSeq;
		this.hhId = hhId;
		this.hhName = hhName;
	...
	public int getCmAnswer() {
		return cmAnswer;
	}

	public void setCmAnswer(int cmAnswer) {
		this.cmAnswer = cmAnswer;
	}
	...
	public String toString() {
		return "ContactMessage [cmSeq=" + cmSeq + ", hhId=" + hhId + ", hhName=" + hhName + ", personId=" + personId
				...
				+ ", cmIndate=" + cmIndate + ", cmStatus=" + cmStatus + ", cmAnswer=" + cmAnswer + "]";
	}
