...
// 	//favorites 카테고리 클릭이벤트
// 	$(".selectPersonList").on("click", function(){
// 		alert("test");
// 		personList();
// 	});
// });
    	...
    	<div class="modal-dialog" style="max-width: 100%; width: 90%; display: table;">
          <div class="modal-content modalone">
            ...
            <span id="sixth"></span>
              	...
              	<br>
              <div id=test class="modal-body1" style="margin-top: 1.3%; margin-bottom: 38%;">
          ...
          <div class="modal-content modalone">
            ...
            <div class="modal-body" style="margin-bottom: 0%; ">
           		 ...
           		 <!-- 0416 모달띄우기 위해서 기존 버튼에서 a태그로 교체하였습니다. -->
		              <a data-toggle="modal" href="#myModal15" class="btn btn-success" id="readResume-btn" style="">이력서보기</a>
    ...
    <nav class="main-nav-outer" id="test2">
		<div class="container">
			<ul class="head-nav">
				...
				<li class="selectPersonList"><a data-toggle="modal" href="#myModal13">Favorites</a></li>
