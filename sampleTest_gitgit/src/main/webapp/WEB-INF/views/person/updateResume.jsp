...
<c:forEach var="education" items="${educationList}">
	...
	<table border="1">								
	<tr>
	<td>학교</td><td><input type="text" id="schoolName" name="schoolName" value="${education.schoolName}"></td>
	</tr><tr>
	<td>전공</td><td><input type="text" id="major" name="major"  value="${education.major}"></td>
	</tr>
	
	<c:if test="${education.diploma ne '0'}">
	
	<tr>
	<td>학위</td><td></td><input type="text" id="diploma" name="diploma"  value="${education.diploma}"></td>	
	</tr>
	
	</c:if>

	<tr>
	<td>입학일</td><td><input type="date" id="eduStartDate" name="eduStartDate"  value="${education.eduStartDate}"></td>
	</tr><tr>
	<td>졸업일</td><td><input type="date" id="eduEndDate" name="eduEndDate"  value="${education.eduEndDate}"></td>
	</tr>
	</table>
