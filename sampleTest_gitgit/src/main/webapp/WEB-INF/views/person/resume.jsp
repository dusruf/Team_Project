...
function showEdu1(){
	...
	data+='<input type="button" id="addEdu1" value="＋" style="margin-left: 37.6%;">';
...
function addCerti(){
	...
	certiContent+='<h3 class="crres">보유자격증 </h3><input type="text" name="certiTitle" class="form-control1" value="" placeholder="클릭해서 선택하세요."><br>';
	certiContent+='<h3 class="crres">발급기관 </h3><input type="text" name="certiOrg" class="form-control" value="" placeholder="발급기관을 입력하세요."><br>';
	certiContent+='<h3 class="crres">취득일자 </h3><input type="date" name="certiDate" class="form-control" value=""><br>';
...
function autocom(){
	$(".form-control1").autocomplete({
		        source: availableCity, // 타이핑시 보여주는 
		        select: function(event, ui) { // 선택시 input 칸에 값 표시 및 들어가는 
		            console.log(ui.item);
		        },
		        focus: function(event, ui) { // 마우스로 포커스시 포커스된 거 외에 안보이게 되는 버그 잡는거
		            return false;
