...
<h3>등록된 이력서가 없습니다.</h3>
 ...
 <input type="button" class="btn btn-primary" value="이력서 등록" onClick="location.href ='regResume';">
...
<c:forEach var="education" items="${educationList}">
	...
	<table border="1">								
	<tr>
	<td>학교</td><td>${education.schoolName}</td>
	</tr><tr>
	<td>전공</td><td>${education.major}</td>
	</tr><tr>
	<td>입학일</td><td>${education.eduStartDate}</td>
	</tr><tr>
	<td>졸업일</td><td>${education.eduEndDate}</td>
	</tr>
	</table>
	<br>		
