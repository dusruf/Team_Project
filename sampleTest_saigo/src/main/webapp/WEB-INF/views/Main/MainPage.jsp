		    ...
		    <div class="modal-dialog">
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
		          <br>		          
		          <input type="text" class="form-control" name="personId" placeholder="아이디를 입력하세요." id="personId" style="margin-left: 2%;"><br><br> <!-- 0421 style 추가 -->
		          <input type="password" class="form-control" name="personPw" placeholder="비밀번호를 입력하세요." id="personPw" style="margin-left: 2%;"><br><br> <!-- 0421 style 추가 -->       	  
		          <input type="text" class="form-control" name="personName" placeholder="이름을 입력하세요." id="personName"  style="margin-left: 2%;"><br><br> <!-- 0421 style 추가 -->
		          <input type="text" class="form-control" name="personEmail" placeholder="E-mail을 입력하세요." id="personEmail" style="margin-left: 2%;"> <!-- 0421 style 추가 -->
		  ...
		  <div class="modal fade" id="companyModal" role="dialog">
		    <div class="modal-dialog">
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
		        <br>
		          <input type="text" id="hhId" name="hhId" class="form-control" placeholder="아이디를 입력하세요." style="margin-left: 2%;">
		          <br>  <br>
		          <input type="password" id="hhPw" name="hhPw" class="form-control" placeholder="비밀번호를 입력하세요." style="margin-left: 2%;">
		          <br>  <br>
		          <input type="text" id="cdn" name="cdn" class="form-control" placeholder="사업자등록번호를 입력하세요." style="margin-left: 2%;">
		          <br>  <br>
		          <input type="text" id="hhName" name="hhName" class="form-control" placeholder="회사명을 입력하세요." style="margin-left: 2%;">
		          <br>  <br>
		          <input type="text" id="representative" name="representative" class="form-control" placeholder="담당자 이름을 입력하세요." style="margin-left: 2%;">
		          <br>  <br>
		          <input type="text" id="phone" name="phone" class="form-control" placeholder="회사대표번호를 입력하세요." style="margin-left: 2%;">
		          <br>  <br>
		          <input type="text" id="addr" name="addr" class="form-control" placeholder="회사주소를 입력하세요." style="margin-left: 2%;">
		          <br>  <br>
		          <input type="text" id="hhEmail" name="hhEmail" class="form-control" placeholder="회사 E-mail을 입력하세요." style="margin-left: 2%;">
		          <br>
