...
function button(){
	...
	totalButton+='<input type="button" class="addEducation" value="학력추가" style="margin:-20% 0% 0% 83%; position: fixed; width:10%;">'; //스타일 주고 br태그 삭제
	totalButton+='<input type="button" class="addCareer" value="경력 추가" style="margin:-18% 0% 0% 83%; position: fixed; width:10%;">';   //스타일 주고 br태그 삭제
	totalButton+='<input type="button" class="addAbility" value="보유 기술 및 능력 추가" style="margin: -16% 0% 0% 83%; position: fixed; width:10%;">';  //스타일 주고 br태그 삭제
	totalButton+='<input type="button" class="addActivity" value="활동 추가" style="margin:-14% 0% 0% 83%; position: fixed; width:10%;">'; //스타일 주고 br태그 삭제
	totalButton+='<input type="button" class="addCerti" value="자격증 추가" style="margin: -12% 0% 0% 83%; position: fixed; width:10%;">'; //스타일 주고 br태그 삭제
	totalButton+='<input type="button" class="addLanguage" value="언어 점수 추가" style="margin: -10% 0% 0% 83%; position: fixed; width:10%;">'; //스타일 주고 br태그 삭제
...
function showEdu1(){
	...
	data+='<h3 class="crres">학교명</h3> <input type="text" class="form-control" name="schoolName" style="margin-left:20%;"><br>'; //0422 h3클래스/스타일/인풋클래스 추가
	data+='<h3 class="crres">전공 계열</h3> <input type="text" class="form-control" name="major" style="margin-left:20%;"><br>';	 //0422 h3클래스/스타일/인풋클래스 추가				 							
	data+='<h3 class="crres">재학기간</h3>  <input type="date" class="form-control" name="eduStartDate" style="margin-left:20%;"><h3 class="crres" style="margin:-2% 0 0 24%;">~</h3>';   //0422 h3클래스/스타일/인풋클래스 추가
	data+='<input type="date" class="form-control" name="eduEndDate" style="margin:-1.8% 0% 0% 43%;"><br>';	 //0422 스타일/인풋 클래스 추가
	data+='<input type="button" class="btn btn-info" id="addEdu1" value="학력추가" style="margin-left: 57.5%;">'; //0422 스타일/버튼 클래스 추가
	data+='<input type="hidden" name="diploma" value="0">';
...
function showEdu2(){
	...
	data+='<h3 class="crres">학교명</h3> <input type="text" class="form-control" name="schoolName" style="margin-left:20%;"><br>'; //0422 h3클래스/스타일/인풋클래스 추가
	data+='<h3 class="crres">전공 </h3> <input type="text" class="form-control" name="major" style="margin-left:20%;"><br>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<h3 class="crres">재학기간</h3> <input type="date" class="form-control" name="eduStartDate" style="margin-left:20%;"><h3 class="crres" style="margin:-2% 0 0 24%;">~</h3>'; //0422 h3클래스/스타일/인풋클래스 추가
	data+='<input type="date" class="form-control" name="eduEndDate" style="margin:-1.8% 0% 0% 43%;"><br>';	//0422 스타일/인풋 클래스 추가
	data+='<input type="button" class="btn btn-info" id="addEdu2" value="학력추가" style="margin-left: 57.5%;">';//0422 스타일/버튼 클래스 추가
	data+='<input type="hidden" name="diploma" value="0">';
...
function showEdu3(){
	...
	data+='<h3 class="crres">전공 </h3> <input type="text" class="form-control" name="major" style="margin-left:20%;"><br>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<h3 class="crres">재학기간</h3> <input type="date" class="form-control" name="eduStartDate" style="margin-left:20%;"><h3 class="crres" style="margin:-2% 0 0 24%;">~</h3>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<input type="date" class="form-control" name="eduEndDate" style="margin:-1.8% 0% 0% 43%;"><br>';	//0422 h3클래스/스타일/인풋클래스 추가
	data+='<input type="hidden" name="diploma" value="0">';
	data+='<input type="button" class="btn btn-info" id="addEdu3" value="학력추가" style="margin-left: 57.5%;">';//0422 스타일/버튼 클래스 추가
...
//	data+='(이게 붙는게 맞나)';
	...
	data+='<h3 class="crres">학교명</h3> <input type="text" class="form-control" name="schoolName" style="margin-left:20%;"><br>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<h3 class="crres">전공 </h3> <input type="text" class="form-control" name="major" style="margin-left:20%;"><br>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<h3 class="crres">학위</h3> <select name="diploma" class="form-control" style="margin-left:20%;">';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<option value="석사">석사</option>';
	data+='<option value="석박사">석박사</option>';
	data+='<option value="박사">박사</option></select><br>';
	data+='<h3 class="crres">재학기간 </h3> <input type="date" class="form-control" name="eduStartDate" style="margin-left:20%;"><h3 class="crres" style="margin:-2% 0 0 24%;">~</h3>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<input type="date" class="form-control" name="eduEndDate" style="margin:-1.8% 0% 0% 43%;"><br>';	
	data+='<input type="button" class="btn btn-info" id="addEdu4" value="학력추가" style="margin-left: 57.5%;">';//0422 스타일/버튼 클래스 추가
...
function edu1(){
	...
	data+='<h3 class="crres">전공 계열 </h3> <input type="text"class="form-control"  name="major" style="margin-left:20%;"><br>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<h3 class="crres">재학기간</h3> <input type="date" class="form-control" name="eduStartDate" style="margin-left:20%;"><h3 class="crres" style="margin:-2% 0 0 24%;">~</h3>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<input type="date" class="form-control" name="eduEndDate" style="margin:-1.8% 0% 0% 43%;"><br>';	//스타일/인풋클래스 추가
	data+='<input type="hidden" name="diploma" value=0>';
	data+='<input type="button" class="deleteEdu1" del_value="eduDiv'+education_cnt+'" value="삭제" style="margin:0% 0% 0% 59%;">';//0422 /스타일 추가
	data+='</div>';
...
function edu2(){
	...
	data+='<h3 class="crres">전공 </h3> <input type="text" class="form-control" name="major"  style="margin-left:20%;"><br>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<h3 class="crres">재학기간 </h3> <input type="date" class="form-control" name="eduStartDate"  style="margin-left:20%;"><h3 class="crres" style="margin:-2% 0 0 24%;">~</h3>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<input type="date" class="form-control" name="eduEndDate" style="margin:-1.8% 0% 0% 43%;"><br>';	//0422 /스타일/인풋클래스 추가
	data+='<input type="hidden" name="diploma" value=0>';
	data+='<input type="button" id="deleteEdu1" value="삭제" style="margin:0% 0% 0% 59%;">';//0422 /스타일 추가
...
function edu4(){
	...
	data+='<h3 class="crres">학교명 </h3> <input type="text" class="form-control" name="schoolName"  style="margin-left:20%;"><br>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<h3 class="crres">전공 </h3> <input type="text" class="form-control" name="major" style="margin-left:20%;"><br>';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<h3 class="crres">학위 </h3> <select class="form-control" name="diploma" style="margin-left:20%;">';//0422 h3클래스/스타일/인풋클래스 추가
	data+='<option value="석사">석사</option>';
	data+='<option value="석박사">석박사</option>';
	data+='<option value="박사">박사</option></select><br>';
	data+='<h3 class="crres">재학기간 </h3> <input type="date" class="form-control" name="eduStartDate" style="margin-left:20%;"><h3 class="crres" style="margin:-2% 0 0 24%;">~</h3>';//0422 h3클래스/스타일/인풋클래스 추가
...
function addCareer(){
	...
	careerContent+='<h3 class="crres">회사명 </h3><input type="text" class="form-control" id="careerName" name="companyName" value="" placeholder="회사명을 입력하세요." style="margin-left: 20%;"><br>';
	careerContent+='<h3 class="crres">분야 </h3><input type="text" class="form-control" id="careerName" name="careerCategory" value="" placeholder="분야를 입력하세요." style="margin-left: 20%;"><br>';
	careerContent+='<h3 class="crres">시작일 </h3><input type="date" class="form-control" id="careerName" name="careerStartDate" value="" style="margin-left: 20%;"><br>';
	careerContent+='<h3 class="crres">종료일 </h3><input type="date" class="form-control" id="careerName" name="careerEndDate" value="" style="margin-left: 20%;"><br>';
	careerContent+='<h3 class="crres">부서</h3><input type="text" class="form-control" id="careerName" name="careerDepartment" value="" placeholder="부서를 입력하세요." style="margin-left: 20%;"><br>';
	careerContent+='<h3 class="crres">직책</h3><input type="text" class="form-control" id="careerName" name="careerPosition" value="" placeholder="직책을 입력하세요." style="margin-left: 20%;"><br>';
	careerContent+='<h3 class="crres">지역</h3><input type="text" class="form-control" id="careerName" name="careerRegion" value="" placeholder="근무지역을 입력하세요." style="margin-left: 20%;"><br>';
	careerContent+='<h3 class="crres">연봉</h3><input type="text" class="form-control" id="careerName" name="careerSalary" value="" placeholder="연봉을 입력하세요." style="margin-left: 20%;"><br>';
	...
	careerContent+='<input type="button" id="addrerere" class="btn btn-info" value="경력추가" onclick="addCareer()" style="margin-left: 41.4%;">';
...
function addActivity(){
	...
	activityContent+='<h3 class="crres">대외활동 </h3><input type="text" name="activityTitle" class="form-control" id="activityty" value="" placeholder="대외활동을 입력하세요." style="margin-left: 20%;"><br>'; //0422 스타일추가
	activityContent+='<h3 class="crres">대외활동기관 </h3><input type="text" name="activityOrg" class="form-control" id="activityty" value="" placeholder="대외활동기관을 입력하세요." style="margin-left: 20%;"><br>';//0422 스타일추가
	activityContent+='<h3 class="crres" style="margin-top: 1%;">특이사항</h3>';
	activityContent+='<textarea class="form-control" name="activityDetails" col-sm-5" rows="4" style="margin-left:20%; max-width:100%; width:30%; margin-top: 1%;" placeholder="특이사항을 입력하세요."></textarea>';
	activityContent+='<br><br><br><br><br><br><br>';
	activityContent+='<div class="plus22">';
	activityContent+='<input type="button" id="abilityty" del_value="activityDiv'+activity_cnt+'" class="deleteActivity" value="대외활동삭제" style="margin:-11% 0% 0% 44.3%;">'; //0422 스타일추가
...
function addLanguage(){
	...
	var languageContent="";
		...
		languageContent+='<h3 class="crres">언어종류 </h3><input type="text" name="languageType" class="form-control" id="languagege" value="" placeholder="클릭해서 선택하세요." style="margin-left: 20%;"><br>';//0422 스타일추가
		languageContent+='<h3 class="crres">자격증 </h3><input type="text"  name="languageTitle" class="form-control" id="languagege" value="" placeholder="클릭해서 선택하세요." style="margin-left: 20%;"><br>';//0422 스타일추가
		languageContent+='<h3 class="crres">점수 </h3><input type="text" name="languageScore" class="form-control" id="languagege" value="" placeholder="점수를 입력하세요." style="margin-left: 20%;"><br>';//0422 스타일추가
		languageContent+='<h3 class="crres">취득일자 </h3><input type="date" name="languageDate" class="form-control" id="languagege" value="" style="margin-left: 20%;"><br>';
		languageContent+='<h3 class="crres">발급기관 </h3><input type="text"  name="languageOrg" class="form-control" id="languagege" value="" placeholder="발급기관을 입력하세요." style="margin-left: 20%;"><br>';//0422 스타일추가
	//	languageContent+='<h3 class="crres" style="margin-top: 1%;">특이사항</h3>';
	//	languageContent+='<textarea class="form-control col-sm-5" rows="4" style="margin-left:3.7%; max-width:100%; width:30%; margin-top: 1%;" placeholder="특이사항을 입력하세요." style="margin-left: 20%;"></textarea>';//0422 스타일추가
		languageContent+='<br><br><br><br><br><br><br>';
		languageContent+='<div class="plus22">';
		languageContent+='<input type="button" id="abilityty" class="btn btn-info" value="언어점수추가" onclick="addLanguage()" style="margin-left: 27%; margin-top:-14%;">';
		languageContent+='<input type="button" id="abilityty" class="deleteLanguageScore" del_value="languageDiv'+language_cnt+'" style="margin-top:-14%;" value="언어점수삭제"></div>';
		languageContent+='</div>';
...
function addCerti(){
	...
	certiContent+='<h3 class="crres">보유자격증 </h3><input type="text" name="certiTitle" class="form-control" id="certificatete" value="" placeholder="클릭해서 선택하세요." style="margin-left: 20%;"><br>';//0422 스타일추가
	certiContent+='<h3 class="crres">발급기관 </h3><input type="text" name="certiOrg" class="form-control" id="certificatete" value="" placeholder="발급기관을 입력하세요." style="margin-left: 20%;"><br>';//0422 스타일추가
	certiContent+='<h3 class="crres">취득일자 </h3><input type="date" name="certiDate" class="form-control" id="certificatete" value="" style="margin-left: 20%;"><br>';//0422 스타일추가
...
//	certiContent+='<textarea class="form-control col-sm-5" rows="4" style="margin-left:3.7%; max-width:100%; width:30%; margin-top: 1%;" placeholder="특이사항을 입력하세요."></textarea>';
	...
	certiContent+='<input type="button" id="abilityty" class="btn btn-info" value="자격증추가" onclick="addCerti()" style="margin:-13% 0% 0% 28.7%;">';//0422 스타일추가
	certiContent+='<input type="button" id="abilityty" class="deleteCerti" del_value="certificateDiv'+certi_cnt+'" value="자격증삭제" style="margin-top:-13%;">';
	certiContent+='</div>';
	certiContent+='</div>';
...
function addAbility(){
	...
	abilityContent+='<h3 class="crres">보유기술 </h3><input type="text" name="abilityTitle" class="form-control" id="abilitytitle" value="" placeholder="보유기술을 입력하세요." style="margin-left: 20%;"><br>';
	abilityContent+='<h3 class="crres">수준 </h3><input type="text" name="abilityStatus" class="form-control" id="careerName" value="" placeholder="사용능력을 입력하세요." style="margin-left: 20%;"><br>';
	...
	abilityContent+='<input type="button" id="abilityty" class="btn btn-info" value="보유기술추가" onclick="addAbility()" style="margin-left: 38.5%;">';
...
<div class="formDiv" style="z-index: 1050;">
	<div id="totalDiv">
	    ...
	    <h3 class="crres">이름 </h3><input type="text" class="form-control" id="resName" name="personName" value="${sessionScope.personName}" placeholder="이름을 입력하세요." style="margin-left: 20%;"><br>
	    <h3 class="crres">생년월일</h3><input type="date" class="form-control" id="resDate" name="birthDate" value="" style="margin-left: 20%;"><br>
	   
	   <!-- 성별설정 스타트-->
	    <h3 class="crres">성별</h3> 
	    	<div class="mafmale" style="margin-left: 20%;">
		 ...
		 <!-- 성별설정 종료-->
		<br>
		<h3 class="crres">이메일 </h3><input type="text" class="form-control" id="resName" name="personEmail" value="${sessionScope.personEmail}" placeholder="이메일을 입력하세요." style="margin-left: 20%;"><br>
		<h3 class="crres">전화번호 </h3><input type="text" class="form-control" id="personPhone" name="personPhone" value="" placeholder="전화번호를 입력하세요." style="margin-left: 20%;"><br>
		<h3 class="crres">주소 </h3><input type="text" class="form-control" id="personAddr" name="personAddr" value="" placeholder="주소를 입력하세요." style="margin-left: 20%;"><br> 
					</div><!-- basicInfoDiv -->
		...
		<input type="hidden" name="updateResumeSeq" value="0">
